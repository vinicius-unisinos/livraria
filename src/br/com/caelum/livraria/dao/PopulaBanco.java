...
public class PopulaBanco {
	...
	public static void main(String[] args) {
		...
		Autor assis = geraAutor("Machado de Assis","MachadodeAssis@gmail.com");
		em.persist(assis);

		Autor amado = geraAutor("Jorge Amado","ja@gmail.com");
		em.persist(amado);

		Autor coelho = geraAutor("Paulo Coelho", "pc@gmail.com");
		em.persist(coelho);

		Autor lobato = geraAutor("Monteiro Lobato","ml@hotmail.com");
		em.persist(lobato);
